...
const cpuCard = document.querySelector("#computer-card");
const userCard = document.querySelector("#player-card");
const userCardImage = document.querySelector("#userCard");
const cpuCardImage = document.querySelector("#cpuCard");
...
dealButton.addEventListener("click", () => {
  ...
  userCardImage.src = card1.img;
  userCount.textContent = card1.value;

  cpuCardImage.src = card2.img;
